const openModalBtn = document.getElementById("aboutMe");
...
openModalBtn.addEventListener("click", function () {
    document.querySelector("#modalScreen").classList.add("open");
    })
closeModalBtn.addEventListener("click", function() {
    document.querySelector("#modalScreen").classList.remove("open");
    })
openBtn.addEventListener("click", function () {
    document.querySelector("#modal-screen").classList.add("open");
    })
closeBtn.addEventListener("click", function() {
    document.querySelector("#modal-screen").classList.remove("open");
    })
